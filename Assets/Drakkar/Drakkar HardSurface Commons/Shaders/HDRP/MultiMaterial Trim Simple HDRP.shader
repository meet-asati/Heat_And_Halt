...
Shader "Drakkar/HDRP/MultiMaterial/MultiMaterial Trim Simple"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				output.ase_texcoord7.xyz = vertexToFrag204;
						...
						)
			{
				...
				float4 tex2DNode197 = tex2D( _TrimSheet, TexUV136 );
				...
				float2 texCoord7_g323 = packedInput.uv1.xy * temp_cast_5 + temp_cast_6;
				...
				float3 lerpResult109 = lerp( float3( 0,0,1 ) , UnpackNormalScale( tex2D( _Normal, TexUV136 ), 1.0f ) , Trim_Normal_Mask187);
				...
				float3 vertexToFrag204 = packedInput.ase_texcoord7.xyz;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh  )
			{
				...
				float3 localMerge3Colors96 = Merge3Colors96( C096 , C196 , C296 , In96 );
				float3 vertexToFrag204 = localMerge3Colors96;
				output.ase_texcoord4.xyz = vertexToFrag204;
				
				output.ase_texcoord2.xy = inputMesh.uv0.xy;
				output.ase_color = inputMesh.ase_color;
				output.ase_texcoord2.zw = inputMesh.uv2.xy;
				output.ase_texcoord3.xy = inputMesh.uv1.xy;
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float Trim_Occlusion191 = tex2DNode197.r;
				float Occlusion154 = Trim_Occlusion191;
				float2 texCoord57 = packedInput.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
				float4 Vector1_g313 = ( tex2D( _VinylTrimsheet, texCoord57 ) * saturate( _VinylSelect ) );
				float Index1_g313 = floor( ( _VinylSelect - 1.0 ) );
				float localVectorIndex1_g313 = VectorIndex1_g313( Vector1_g313 , Index1_g313 );
				float In152 = _VinylMaterial;
				...
				float2 temp_cast_5 = (_Tiling).xx;
				float2 temp_cast_6 = (_Blend).xx;
				float2 texCoord7_g323 = packedInput.ase_texcoord3.xy * temp_cast_5 + temp_cast_6;
				float4 tex2DNode10_g323 = tex2D( _SurfaceTexture, texCoord7_g323 );
				float4 break68 = tex2DNode10_g323;
				float Texture_R95 = break68.x;
				float4 Vector1_g308 = _ColorOffset;
				...
				float3 vertexToFrag204 = packedInput.ase_texcoord4.xyz;
				float3 Glow100 = vertexToFrag204;
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				output.ase_color = inputMesh.ase_color;
				output.ase_texcoord4.zw = inputMesh.ase_texcoord2.xy;
				output.ase_texcoord5.xy = inputMesh.ase_texcoord1.xy;
					...
					)
			{
				...
				float4 Vector1_g311 = _SmoothnessOffset;
				float2 texCoord57 = packedInput.ase_texcoord4.zw * float2( 1,1 ) + float2( 0,0 );
				float4 Vector1_g313 = ( tex2D( _VinylTrimsheet, texCoord57 ) * saturate( _VinylSelect ) );
				float Index1_g313 = floor( ( _VinylSelect - 1.0 ) );
				float localVectorIndex1_g313 = VectorIndex1_g313( Vector1_g313 , Index1_g313 );
				float In152 = _VinylMaterial;
				...
				float2 temp_cast_5 = (_Tiling).xx;
				float2 temp_cast_6 = (_Blend).xx;
				float2 texCoord7_g323 = packedInput.ase_texcoord5.xy * temp_cast_5 + temp_cast_6;
				float4 tex2DNode10_g323 = tex2D( _SurfaceTexture, texCoord7_g323 );
				float4 break68 = tex2DNode10_g323;
				float Smoothness_Source111 = break68.w;
				float Pattern_1_Source70 = break68.y;
		...
		Pass
		{
				...
				)
			{
				...
				float4 Vector1_g311 = _SmoothnessOffset;
				float2 texCoord57 = packedInput.ase_texcoord3.zw * float2( 1,1 ) + float2( 0,0 );
				float4 Vector1_g313 = ( tex2D( _VinylTrimsheet, texCoord57 ) * saturate( _VinylSelect ) );
				float Index1_g313 = floor( ( _VinylSelect - 1.0 ) );
				float localVectorIndex1_g313 = VectorIndex1_g313( Vector1_g313 , Index1_g313 );
				float In152 = _VinylMaterial;
				...
				float2 temp_cast_5 = (_Tiling).xx;
				float2 temp_cast_6 = (_Blend).xx;
				float2 texCoord7_g323 = packedInput.ase_texcoord4.xy * temp_cast_5 + temp_cast_6;
				float4 tex2DNode10_g323 = tex2D( _SurfaceTexture, texCoord7_g323 );
				float4 break68 = tex2DNode10_g323;
				float Smoothness_Source111 = break68.w;
				float Pattern_1_Source70 = break68.y;
		...
		Pass
		{
						...
						)
			{
				...
				float3 vertexToFrag204 = packedInput.ase_texcoord9.xyz;
				float3 Glow100 = vertexToFrag204;
...
Node;AmplifyShaderEditor.CommentaryNode;20;-2895.346,-526.9056;Inherit;False;1701.329;681.2104;Trim Sheet + Parallax Occlusion Mapping;15;197;193;192;191;190;188;187;137;136;128;109;108;38;37;36;;1,1,1,1;0;0
...
ASEEND*/
//CHKSM=CAE037BF1CF784E4D36DCF6E3E67140F22035AB1